...
var drawingCurve = false; // Nuevo, para rastrear si se estÃ¡ dibujando una curva
...
function draw(event) {
  ...
  if (drawingTool === "linea") {
    ...
    drawingLine = false;//hace que cuando presionas lapiz la prÃ³xima linea empiece en un punto nuevo
    if (oldtool != "lapiz") {
      ctx2.beginPath();
    }
...
function descargarImagen() {
  ...
  // Verificar si el elemento canvas estÃ¡ presente
  if (!canvas) {
